#!/usr/bin/julia
# Archived version: 10 on 09-06-15 at 06:54:19 PM IST
...
@simd for k = 1:dataSize
	...
	return (X[dataidx,:], y[dataidx,:])
end

#---------------------------------------------------------------------------
#---------------------------------------------------------------------------			
function preboost(y::Array{Int64}, trueRatio::Float64, dataSize::Int64)
